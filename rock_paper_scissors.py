...
# created an if statement to determine which output is shown to the user dependent on which tool they picked
    if tool == 'r':
...
# created a while loop to ensure correct letters are used
    ...
    # created a variable called userchoice to store the result of the function
